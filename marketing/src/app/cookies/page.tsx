...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "CapVeri cookie policy: how we use essential, analytics, and marketing cookies. Learn how to manage your cookie preferences.",
  alternates: {
    canonical: `${publicKnowledge.company.siteUrl}/cookies`,
  },
};
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              CapVeri.com uses cookies for the following purposes:
            </p>
