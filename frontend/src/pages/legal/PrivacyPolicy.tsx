 ...
 * Privacy Policy Page
 *
 * Standard privacy policy for CapVeri
 */
...
export function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Privacy Policy - CapVeri"
        description="CapVeri privacy policy: how we collect, use, and protect customer data."
        canonical="/privacy"
      />
        ...
        <div className="max-w-3xl space-y-6">
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              CapVeri collects information you provide directly, including:
            </p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li>
                ...
                through OpenRouter under product data-handling controls. See our{' '}
                <a
