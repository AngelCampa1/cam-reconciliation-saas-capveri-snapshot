...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary - Brand Blue (with full scale)
        primary: {
        ...
        destructive: {
          ...
          // F-287: dark on-light shade for AA text/icons on white or the /5 wash
        ...
        warning: {
          ...
          // dark on-light amber for AA text/icons on white (not on a wash)
        ...
        // Refined border variants
        "border-subtle": "hsl(var(--border-subtle))",
        "border-strong": "hsl(var(--border-strong))",
        "border-hover": "hsl(var(--border-hover))",
        // Extended status/badge colors
        status: {
          neutral: {
      ...
      spacing: {
        ...
        xl: "var(--spacing-6)", // 24px
        "2xl": "var(--spacing-8)", // 32px
        "3xl": "var(--spacing-12)", // 48px
        "4xl": "var(--spacing-16)", // 64px
      },
      zIndex: {
        sticky: "var(--z-sticky)",
        fixed: "var(--z-fixed)",
      ...
      animation: {
        ...
        "progress-circular": "progress-circular 1.5s linear infinite",
