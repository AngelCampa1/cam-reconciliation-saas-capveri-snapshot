-- ==============================================================================
-- CapVeri - Base Seed Data
-- ==============================================================================
--
-- PURPOSE: Auto-loads with migrations to provide base test data for E2E testing.
--
-- COVERAGE:
-- - 6 organizations (5 test orgs + 1 demo)
-- - 17 users with all roles (owner, admin, member, viewer, tenant)
-- - 6 properties with BOMA configurations
-- - 48 leases with varied recovery profiles
-- - 90 GL entries (2024: Jan-Jun representative sample)
-- - 30 reconciliation snapshots (2023-2024)
-- - Full tenant portal data (disputes, invitations, tenant users)
-- - Billing integration (subscriptions, invoices)
--
-- LIMITATIONS:
-- - Only 2 years of data (2023-2024)
-- - Journey 2 (Year-over-Year Variance) requires additional historical data
--
-- FOR JOURNEY 2 TESTING:
-- Load supabase/seed_e2e_multi_year_data.sql separately to add 2019-2022, 2025-2026 data.
--
-- LOADS AUTOMATICALLY: This file runs with `supabase db reset` or `supabase start`
--
-- Usage:
--   supabase db reset (automatically runs seed.sql)
--   OR
--   psql -U postgres -h 127.0.0.1 -p 54322 -d postgres < supabase/seed.sql
--
-- ==============================================================================
...
INSERT INTO public.organizations (id, name, subscription_status, settings, created_at, updated_at)
VALUES
    (
...
VALUES
    ('00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'admin@democompany.com', crypt('password', gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}', '{}', false),
    ('00000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'member@democompany.com', crypt('password', gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}', '{}', false)
ON CONFLICT (id) DO NOTHING;

-- Create user profiles with fixed UUIDs
INSERT INTO public.users (id, organization_id, email, full_name, role, created_at, updated_at)
VALUES
    (
...
INSERT INTO public.properties (id, organization_id, name, address_line1, address_line2, city, state, postal_code, total_rentable_sqft, total_usable_sqft, common_area_sqft, target_occupancy, created_at, updated_at)
VALUES
    (
...
VALUES
    -- Downtown Tower Units
    ('00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000101', '101', 1, 5000.00, 4600.00, 'occupied', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000202', '00000000-0000-0000-0000-000000000101', '102', 1, 5000.00, 4600.00, 'occupied', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000203', '00000000-0000-0000-0000-000000000101', '201', 2, 5000.00, 4600.00, 'occupied', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000204', '00000000-0000-0000-0000-000000000101', '202', 2, 5000.00, 4600.00, 'occupied', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000205', '00000000-0000-0000-0000-000000000101', '301', 3, 5000.00, 4600.00, 'vacant', NOW(), NOW()),
    -- Suburban Office Park Units
    ('00000000-0000-0000-0000-000000000211', '00000000-0000-0000-0000-000000000102', 'A-101', 1, 3500.00, 3200.00, 'occupied', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000212', '00000000-0000-0000-0000-000000000102', 'A-201', 2, 3500.00, 3200.00, 'occupied', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000213', '00000000-0000-0000-0000-000000000102', 'B-100', 1, 4000.00, 3700.00, 'vacant', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    (
        ...
        '2026-08-31',
        'active',
        '{"base_year": 2023, "pro_rata_share": "0.047", "admin_fee_percent": "0.15", "gross_up_target": "0.95", "cap_type": "cumulative", "cap_rate": "0.05"}'::jsonb,
...
INSERT INTO public.expense_pools (id, property_id, name, pool_type, is_gross_up_applicable, gross_up_target, created_at, updated_at)
VALUES
    -- Downtown Tower Pools
    ('00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000101', 'Operating Expenses', 'operating', true, 0.95, NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000402', '00000000-0000-0000-0000-000000000101', 'Real Estate Taxes', 'tax', false, NULL, NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000403', '00000000-0000-0000-0000-000000000101', 'Insurance', 'insurance', false, NULL, NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000404', '00000000-0000-0000-0000-000000000101', 'Capital Reserves', 'capital', false, NULL, NOW(), NOW()),
    -- Suburban Office Park Pools
    ('00000000-0000-0000-0000-000000000411', '00000000-0000-0000-0000-000000000102', 'Operating Expenses', 'operating', true, 0.95, NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000412', '00000000-0000-0000-0000-000000000102', 'Real Estate Taxes', 'tax', false, NULL, NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000413', '00000000-0000-0000-0000-000000000102', 'Insurance', 'insurance', false, NULL, NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000414', '00000000-0000-0000-0000-000000000102', 'Capital Reserves', 'capital', false, NULL, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.pool_mappings (id, expense_pool_id, gl_account_pattern, allocation_percentage, priority, created_at, updated_at)
VALUES
    -- Operating Expenses
    ('00000000-0000-0000-0000-000000000501', '00000000-0000-0000-0000-000000000401', '5*', 1.0000, 0, NOW(), NOW()),
    -- Taxes
    ('00000000-0000-0000-0000-000000000502', '00000000-0000-0000-0000-000000000402', '61*', 1.0000, 0, NOW(), NOW()),
    -- Insurance
    ('00000000-0000-0000-0000-000000000503', '00000000-0000-0000-0000-000000000403', '62*', 1.0000, 0, NOW(), NOW()),
    -- Capital
    ('00000000-0000-0000-0000-000000000504', '00000000-0000-0000-0000-000000000404', '7*', 1.0000, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- ==============================================================================
-- COMPREHENSIVE MANUAL TESTING DATA (from seed_manual_testing.sql)
-- ==============================================================================
--
-- The following section creates extensive test data for manual QA testing:
-- - 5 additional organizations (Acme, Beta, Gamma, Delta, Epsilon)
-- - 15 additional users with various roles (Owner, Admin, Member, Viewer, Tenant)
-- - 6 properties with realistic BOMA configurations
-- - 70+ units, 48 leases, 1,482 GL entries (when generated)
-- - Complete reconciliation snapshots, disputes, documents
--
-- All test users use password: TestPass123!
--
-- IMPORTANT:
-- - This adds ~10-15 seconds to database reset time
-- - For faster resets during rapid development, you can temporarily comment out
--   this section (from here to COMMIT at end of file)
-- - To restore manual testing data only, uncomment this section
--
-- ==============================================================================
...
VALUES
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd002'::uuid,
     ...
     '2027-05-31'::date,
     'active',
     '{"base_year": 2022, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.03", "cap_type": "cumulative", "cap_rate": "0.04", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd003'::uuid,
     ...
     '2028-02-28'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.04", "cap_type": "cumulative", "cap_rate": "0.06", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd010'::uuid,
     ...
     '2029-01-31'::date,
     'active',
     '{"base_year": 2024, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.06", "cap_type": "non_cumulative", "cap_rate": "0.05", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd015'::uuid,
     ...
     '2029-02-28'::date,
     'active',
     '{"base_year": 2024, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.05", "cap_type": "none", "cap_rate": null, "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
...
VALUES
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd017'::uuid,
     ...
     '2028-01-31'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.03", "cap_type": "non_cumulative", "cap_rate": "0.06", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '22 months',
     NOW()),
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd025'::uuid,
     ...
     '2028-09-30'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.06", "cap_type": "cumulative_compounding", "cap_rate": "0.05", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '14 months',
     NOW())
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd028'::uuid,
     ...
     '2028-02-28'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.04", "cap_type": "cumulative", "cap_rate": "0.05", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '10 months',
     NOW()),
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd030'::uuid,
     ...
     '2028-04-30'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.10", "cap_type": "non_cumulative", "cap_rate": "0.05", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
...
VALUES
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd035'::uuid,
     ...
     '2028-01-31'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.005", "cap_type": "non_cumulative", "cap_rate": "0.10", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '5 months',
     NOW()),
    ('dddddddd-dddd-dddd-dddd-ddddddddd036'::uuid,
     ...
     '2028-02-28'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.05", "cap_type": "cumulative", "cap_rate": "0.08", "admin_fee_percentage": "0.15", "excluded_pools": ["insurance"]}'::jsonb,
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd037'::uuid,
     ...
     '2028-03-31'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.05", "cap_type": "none", "cap_rate": null, "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '3 months',
     NOW()),
    ('dddddddd-dddd-dddd-dddd-ddddddddd038'::uuid,
     ...
     '2028-04-30'::date,
     'active',
     '{"base_year": 2023, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.05", "cap_type": "cumulative", "cap_rate": "0.05", "admin_fee_percentage": "0.15", "excluded_pools": ["operating"]}'::jsonb,
...
VALUES
    ...
    ('dddddddd-dddd-dddd-dddd-ddddddddd047'::uuid,
     ...
     '2029-12-31'::date,
     'active',
     '{"base_year": 2019, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.03", "cap_type": "cumulative", "cap_rate": "0.05", "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '5 years',
     NOW()),
    ('dddddddd-dddd-dddd-dddd-ddddddddd048'::uuid,
     ...
     '2029-12-31'::date,
     'active',
     '{"base_year": 2019, "base_year_amount": null, "gross_up_base_year": true, "pro_rata_share": "0.10", "cap_type": "none", "cap_rate": null, "admin_fee_percentage": "0.15", "excluded_pools": []}'::jsonb,
     NOW() - INTERVAL '5 years',
     NOW())
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('c1c1c1c1-c1c1-c1c1-c1c1-c1c1c1c10013'::uuid,
     ...
     'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb011'::uuid,
     NOW() - INTERVAL '2 months',
     NOW() - INTERVAL '3 weeks'),
...
VALUES
    ...
    ('c1c1c1c1-c1c1-c1c1-c1c1-c1c1c1c10017'::uuid,
     ...
     NOW() - INTERVAL '2 years',
     'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb012'::uuid,
...
VALUES
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20002'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10001'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20003'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10001'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20006'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10002'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20007'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10002'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20008'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10002'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20010'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10003'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20011'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10003'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
     'Thank you for the clarification. We are reviewing your lease language and will confirm the correct calculation method.',
     false, NOW() - INTERVAL '3 days'),
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20012'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10003'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20014'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10004'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20015'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10004'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20018'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10005'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20019'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10005'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20022'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10006'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
    ...
    ('f2f2f2f2-f2f2-f2f2-f2f2-f2f2f2f20023'::uuid, 'f1f1f1f1-f1f1-f1f1-f1f1-f1f1f1f10006'::uuid, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbb005'::uuid,
...
VALUES
    -- 1. Acme Real Estate Partners - Growth (was Professional, $299/month, active)
    ...
    -- 2. Beta Real Estate Holdings - Growth (was Starter, $99/month, trialing)
    ...
    -- 3. Gamma Medical Properties - Growth (was Free, $0, active, no Stripe)
    ...
    -- 4. Delta Tower Management - Growth (was Professional, $299/month, active)
    ...
    -- 5. Epsilon Ventures - Growth (was Starter, $99/month, active)
...
BEGIN
    ...
    RAISE NOTICE '   - All using Growth plan (simplified billing)';
    RAISE NOTICE '   - 2 formerly Professional: Acme, Delta';
    RAISE NOTICE '   - 2 formerly Starter: Beta (trialing), Epsilon (active)';
    RAISE NOTICE '   - 1 formerly Free: Gamma';
END $$;
...
VALUES
    ...
    -- Gamma Medical Properties - 0 invoices (Growth plan, formerly Free)

    -- Delta Tower Management - 6 paid invoices (Growth plan, formerly Professional $299)
...
BEGIN
    ...
    RAISE NOTICE '- owner@acme.example.com / TestPass123! (2 properties, Growth plan)';
    RAISE NOTICE '- owner@beta.example.com / TestPass123! (Retail Plaza, Growth plan, trialing)';
    RAISE NOTICE '- owner@gamma.example.com / TestPass123! (Medical Building, Growth plan)';
    RAISE NOTICE '- owner@delta.example.com / TestPass123! (Class A Tower, Growth plan)';
    RAISE NOTICE '- owner@epsilon.example.com / TestPass123! (Industrial Complex, Growth plan)';
...
-- VERIFICATION QUERY
-- ==============================================================================
-- Verification Query: Confirm seed data loaded successfully
DO $$
DECLARE
    org_count INTEGER;
    user_count INTEGER;
...
BEGIN
    ...
    RAISE NOTICE 'Leases: %', lease_count;
    RAISE NOTICE '';
